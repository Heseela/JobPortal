              ...
              <input
                ...
                className={`w-full bg-primary-900 border ${
                  errors.fullName
                    ...
                    : "border-primary-800"
                } rounded-lg pl-10 pr-4 py-3 text-primary-100 focus:outline-none focus:border-secondary-500 transition-colors duration-300`}
                {...register("fullName")}
              />
            </div>
            {errors.fullName && (
          ...
          >
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full bg-primary-900 border ${
                  errors.email ? "border-secondary-500" : "border-primary-800"
                } rounded-lg pl-10 pr-4 py-3 text-primary-100 focus:outline-none focus:border-secondary-500 transition-colors duration-300`}
                {...register("email")}
              />
            </div>
              ...
              <input
                ...
                className={`w-full bg-primary-900 border ${
                  errors.password
                    ? "border-secondary-500"
                    : "border-primary-800"
                } rounded-lg pl-10 pr-10 py-3 text-primary-100 focus:outline-none focus:border-secondary-500 transition-colors duration-300`}
                {...register("password")}
              />
              <button
                type="button"
